...
#' res_e$Summary
#' @export
MRVARData = function(n=2,p=matrix(2,2,2),T=100,S=2,SESVI,TH,Bo,Co,Sigmao,Uo,SV,type,X,mu,Yo,Do,d=1) {
...
#' RF4 = girf_MRVAR_RM_CB(RES=res_e, shock=c(1,1), R=100, nstep=20, Omega_hist=NA, resid_method = "parametric", conf_level=c(0.05,0.95), N=100)
...
#' RF4 = girf_MRVAR_RM_CB(RES=res_e, shock=c(1,1), R=200, nstep=20, Omega_hist=NA, resid_method = "parametric", conf_level=c(0.05,0.95), N=100)
#' IRF_list <-IRF_graph(RF4)
#' @export
