...
#' @param Co    : (n,k+1) matrix of the coefficients of deterministic components in a VAR(p) process. For type="none" Co = 0*(1:n), for type="const" Co is an n vector, for type="exog0" Co is a (n,k) matrix, andfor type="exog1" Co is an (n,1+k) matrix.
